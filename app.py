...
from layout import create_happiness_score_choropleth_map as map,create_life_expectancy_scatter_from_csv as life, create_freedom_to_country_graph as free,create_gdp_choropleth_map as gdp,create_social_support_bar_chart as social,create_corruption_bar_chart as cor,create_generosity_scatter_plot as gen
...
# Navbar component
icon = html.A(
    html.Img(src='assets/whr-cover-ico.png', height="100px", id="home-icon"),
    href="/home"
)
